...
# -*- coding: utf-8 -*-
"""
Created on Sun May  6 22:54:54 2018
...
image = cv2.imread("input/dataset-master/JPEGImages/BloodImage_00022.jpg")
tree = ET.parse("input/dataset-master/Annotations/BloodImage_00022.xml")
...
reader = csv.reader(open('input/dataset2-master/labels.csv'))
# skip the header
next(reader)
X3 = []
y3 = []
